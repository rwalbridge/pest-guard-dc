...
export const blogArticles: BlogArticle[] = [
  {
    ...
    titleTag: "When Pest Season Actually Starts in Washington DC | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Do I Have Termites? Signs of Termites in DC | The Nest by PestGuard",
    ...
    content: [
      ...
      { type: 'callout', callout: { type: 'greenshield', text: "PestGuard offers free termite inspections for DC metro homeowners. No obligation. If we don't find termites, we'll tell you that clearly and give you a prevention checklist." }},
    ],
    faqs: [
  ...
  },
  {
    ...
    titleTag: "How to Get Rid of Mice in DC | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Mosquito Control in DC: What Works & What Doesn't | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Cockroach Control in DC: What to Do & What It Means | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Stink Bug Season in DC: Prevention & Control Guide | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Bed Bug Treatment in DC: Detection & Recovery Guide | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Pest-Proof Your DC Home Before Winter | The Nest by PestGuard",
  ...
  },
  {
    ...
    titleTag: "Pest Control Subscription vs One-Time: Which Is Worth It? | The Nest by PestGuard",
    ...
    content: [
      ...
      { type: 'text', text: "Whether you're considering PestGuard or any other company, ask these:" },
      { type: 'list', items: [
      ...
      { type: 'text', text: "These are the same questions we'd encourage you to ask PestGuard — we're happy to answer all six." },
    ],
    faqs: [
  ...
  },
  {
    ...
    titleTag: "Pest Control Cost in DC, MD & VA (2026 Guide) | The Nest by PestGuard",
